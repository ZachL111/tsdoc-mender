"""Regression checks for the tsdoc-mender casebook."""
...
from casebook.harness import assert_expected, tsdoc_mender_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tsdoc_mender_summary(), assert_expected())
