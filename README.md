...
tsdoc-mender is a TypeScript project for developer tools. It focuses on this technical goal: Audit exported APIs for missing examples and stale comments.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 171, risk penalty 7, latency penalty 3, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
