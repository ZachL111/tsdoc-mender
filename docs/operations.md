...
`tsdoc-mender` is centered on developer tools work in TypeScript. The technical target is: Audit exported APIs for missing examples and stale comments.
...
The score is deterministic. The current threshold is 171. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 3.
